    ...
    function DisplayWeather(day) {
        ...
        <div className="col" key={prop.date}>
            ...
            <div className="card-body">
                ...
                <img
                src={`https://openweathermap.org/img/w/${prop.weather_icon}.png`}
                />
                <p className="card-text">
                Weather - {prop.weather} ({prop.weather_description})
                </p>
    ...
    if (prop["facility_id"] != null) {
        ...
        return (
            ...
            <ul key="exceptions">
                ...
                <li key="eWednesday">
                Wednesday - {exception.exceptionHours.wednesday}
                </li>
                <li key="eThursday">
                Thursday - {exception.exceptionHours.thursday}
                </li>
                <li key="eFriday">Friday - {exception.exceptionHours.friday}</li>
                <li key="eSaturday">
                Saturday - {exception.exceptionHours.saturday}
                </li>
            </ul>
            </>
        );
        ...
        <div className="row">
            ...
            <div className="shadow p-1 mt-1">
                ...
                <div className="card-body">
                    ...
                    <p>
                    Staff on Site -{" "}
                    {facility.amenities.staffOrVolunteerHostOnsite}
                    </p>
                    <p>Toilets - {facility.amenities.toilets["0"]}</p>
                    <p>
                    Trash Collection Point -{" "}
                    {facility.amenities.trashRecyclingCollection}
                    </p>
                </div>
                <div className="card-body">
                    <h3>Accessibility:</h3>
                    ...
                    <div className={styles.individual}>
                    <p>
                        Cell Phone Info - {facility.accessibility.cellPhoneInfo}
                    </p>
                    {facility.accessibility.classifications.map(
                        (classification) => (
                        <p key={Math.random()}>
                    ...
                    <div className={styles.individual}>
                    <p>
                        Fire Stove Policy - {facility.accessibility.fireStovePolicy}
                    </p>
                    </div>
                    <div className={styles.individual}>
                    ...
                    <div className={styles.individual}>
                    <p>
                        RV Info - {facility.accessibility.rvInfo}, Allowed -{" "}
                        {facility.accessibility.rvAllowed}, Max Length -{" "}
                        {facility.accessibility.rvMaxLength}
                    </p>
                    </div>
                    <div className={styles.individual}>
                    <p>
                        Trailer Info - {facility.accessibility.trailerInfo}, Max
                        Length - {facility.accessibility.trailerMaxLength}
                    </p>
                    </div>
                    <div className={styles.individual}>
                    <p>
                        Wheelchair Access -{" "}
                        {facility.accessibility.wheelchairAccess}
                    </p>
                    </div>
                    <div className={styles.individual}>
                    <p>
                        Additional Info - {facility.accessibility.additionalInfo}
                    </p>
                    </div>
                </div>
                <div className="card-body">
                    ...
                    <li key="sunday">
                        Sunday -{" "}
                        {facility.operating_hours["0"].standardHours.sunday}
                    </li>
                    <li key="monday">
                        Monday -{" "}
                        {facility.operating_hours["0"].standardHours.monday}
                    </li>
                    <li key="tuesday">
                        Tuesday -{" "}
                        {facility.operating_hours["0"].standardHours.tuesday}
                    </li>
                    <li key="wednesday">
                        Wednesday -{" "}
                        {facility.operating_hours["0"].standardHours.wednesday}
                    </li>
                    <li key="thursday">
                        Thursday -{" "}
                        {facility.operating_hours["0"].standardHours.thursday}
                    </li>
                    <li key="friday">
                        Friday -{" "}
                        {facility.operating_hours["0"].standardHours.friday}
                    </li>
                    <li key="saturday">
                        Saturday -{" "}
                        {facility.operating_hours["0"].standardHours.saturday}
                    </li>
                    </ul>
